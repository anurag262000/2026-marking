    ...
    <div className="min-h-screen bg-black text-white pt-32 pb-20 px-6">
      <div className="max-w-7xl mx-auto">
        <div className="text-center mb-20">
          <h1 className="text-5xl md:text-7xl font-helvetica font-bold mb-6">
            Thoughts & <span className="text-blue-500 italic">Insights</span>
          </h1>
          <p className="text-white/60 text-lg max-w-2xl mx-auto font-light">
            Exploring the intersection of design, technology, and creative
            coding.
          </p>
        </div>
            ...
            <Link href={`/blogs/${blog.slug}`} key={blog.id} className="group">
              <div className="bg-white/5 border border-white/10 rounded-2xl overflow-hidden h-full flex flex-col hover:border-blue-500/50 transition-colors duration-300 relative">
                  ...
                  <div className="aspect-video relative overflow-hidden">
                    ...
                    <div className="absolute top-4 left-4 flex gap-2">
                      {blog.tags?.slice(0, 2).map((tag, i) => (
                        <span
                          key={i}
                          className="bg-black/60 backdrop-blur-md text-white text-[10px] uppercase font-orbitron px-3 py-1 rounded-full border border-white/10"
                        >
                          {tag}
                        </span>
                      ))}
                ...
                <div className="p-8 flex-1 flex flex-col">
                  ...
                  <h2 className="text-2xl font-bold font-helvetica mb-4 leading-tight group-hover:text-blue-400 transition-colors">
                    {blog.title}
                  </h2>
