                    ...
                    <div onClick={(e) => e.stopPropagation()} className="bg-[#1a1a1a] border border-white/20 rounded-3xl p-6 md:p-8 max-w-md w-full relative shadow-2xl shadow-blue-500/10 animate-fade-in-up max-h-[85vh] overflow-y-auto hide-scrollbar">
                        ...
                        {!isSignedIn ? (
                            ...
                            <form action={handleSubmit} className="space-y-5">
                                {/* Avatar Selection */}
                                <div className="mb-4">
                                    <label className="text-[10px] font-orbitron uppercase tracking-wider text-white/70 mb-3 block">Choose Avatar</label>
                                    <div className="flex gap-3 overflow-x-auto px-2 scrollbar-hide py-2">
