...
export const HeroHighlight = ({
  ...
  return (
    (<div
      ...
      <motion.div
        className="absolute inset-0 pointer-events-none bg-dot-thick-indigo-500 dark:bg-dot-thick-indigo-500 [mask-image:radial-gradient(200px_circle_at_var(--mouse-x)_var(--mouse-y),black,transparent)]"
        style={{
